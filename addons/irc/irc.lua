...
windower.register_event('addon command', function (...)
	...
	if args[1] == nil or args[1] == "help" then
		print('IRC addon by Skyrant')
		print('-- //i or //irc to send a message to the irc channel')
		print('General commands:')
		print('-- //irc checkstatus :: check connection status.')
		print('-- //irc connect :: connect to the IRC server.')
		print('-- //irc disconnect :: disconnect from the irc server.')
		print('Settings:')
		print('-- //irc chatcolor [colornumber: 001-256] :: change the chatcolor.')
		print('-- //irc server [servername] :: set the server to connect to.')
		print('-- //irc port [portnumber] :: set the irc server port.')
		print('-- //irc channel [channelname] :: switch to a channel (will part current channel).')
		print("Don't forget to save your settings:")
		print('-- //irc save')
