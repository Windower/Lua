local _fns = T{
    ...
    main_job        = function() return windower.ffxi.get_player().main_job end,
    main_job_level  = function() return windower.ffxi.get_player().main_job_level end,
    main_job_full   = function() return windower.ffxi.get_player().main_job_full end,
    main_job_id     = function() return windower.ffxi.get_player().main_job_id end,
    status          = function() return windower.ffxi.get_player().status end,
    status_id       = function() return windower.ffxi.get_player().status_id end,
    index           = function() return windower.ffxi.get_player().index end,
    sub_job         = function() return windower.ffxi.get_player().sub_job end,
    sub_job_level   = function() return windower.ffxi.get_player().sub_job_level end,
    sub_job_full    = function() return windower.ffxi.get_player().sub_job_full end,
    ...
    divine          = function() return windower.ffxi.get_player().skills.divine end,
    healing         = function() return windower.ffxi.get_player().skills.healing end,
    enhancing       = function() return windower.ffxi.get_player().skills.enhancing end,
    enfeebling      = function() return windower.ffxi.get_player().skills.enfeebling end,
    elemental       = function() return windower.ffxi.get_player().skills.elemental end,
    dark            = function() return windower.ffxi.get_player().skills.dark end,
    summoning       = function() return windower.ffxi.get_player().skills.summoning end,
    ...
    string          = function() return windower.ffxi.get_player().skills.string end,
    wind            = function() return windower.ffxi.get_player().skills.wind end,
    ...
    day         = function() return windower.ffxi.get_info().day end,
    day_element = function() return windower.ffxi.get_info().day_element end,
    moon        = function() return windower.ffxi.get_info().moon end,
    moon_pct    = function() return windower.ffxi.get_info().moon_pct end,
    time        = function() return windower.ffxi.get_info().time end,
    zone        = function() return windower.ffxi.get_info().zone end,
    zone_id     = function() return windower.ffxi.get_info().zone_id end,
    logged_in   = function() return windower.ffxi.get_info().logged_in end,
    weather     = function() return windower.ffxi.get_info().weather end,
    weather_id  = function() return windower.ffxi.get_info().weather_id end,
